...
type ProfilesClientAPI interface {
	...
	ListByResourceGroupX(ctx context.Context, resourceGroupName string) (result cdn.ProfileListResultPage, err error)
	ListByResourceGroupXComplete(ctx context.Context, resourceGroupName string) (result cdn.ProfileListResultIterator, err error)
